...
namespace NORI
{
    partial class frmPermisos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gcPermisos.EmbeddedNavigator.ButtonClick += new DevExpress.XtraEditors.NavigatorButtonClickEventHandler(gcPermisos_EmbeddedNavigator_ButtonClick);
            ...
            this.gcPermisos.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[2] { this.cbUsuarios, this.cbObjetos });
            this.gcPermisos.Size = new System.Drawing.Size(677, 468);
            this.gcPermisos.TabIndex = 0;
            this.gcPermisos.UseEmbeddedNavigator = true;
            this.gcPermisos.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[1] { this.gvPermisos });
            this.gvPermisos.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[13]
            {
            this.gridColumnID, this.gridColumnUsuarioID, this.gridColumnObjeto, this.gridColumnAgregar, this.gridColumnActualizar, this.gridColumnCancelar, this.gridColumnCancelarCFDI, this.gridColumnEliminar, this.gridColumnAutorizacion, this.gridColumnUsuarioAutorizacionID,
            this.gridColumnApp, this.gridColumnActivo, this.gridColumnFecha
            });
            ...
            this.gvPermisos.InitNewRow += new DevExpress.XtraGrid.Views.Grid.InitNewRowEventHandler(gvPermisos_InitNewRow);
            ...
            this.cbUsuarios.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
            {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)
            });
            this.cbUsuarios.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[1]
            {
            ...
            this.cbObjetos.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
            {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)
            });
            this.cbObjetos.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[2]
            {
            ...
            base.ClientSize = new System.Drawing.Size(681, 472);
            base.Controls.Add(this.panel1);
            base.IconOptions.Image = componentResourceManager.Resources.logo;
            base.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
            base.Name = "frmPermisos";
