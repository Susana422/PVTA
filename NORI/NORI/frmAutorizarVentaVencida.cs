...
namespace NORI
{
    public partial class frmAutorizarVentaVencida : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public Usuario usr;
        public frmAutorizarVentaVencida()
        {
            InitializeComponent();
        ...
        {
            frmDocumentos frmDoc = this.Owner as frmDocumentos;
            if (frmDoc != null)
            {       
                if (usr != null) {
                    ...
                    if (usr.ObtenerContraseña() == ((Control)(object)txtContraseña).Text)
                    {
                        ...
                        autOrder.documento = frmDoc.documento.id;
                        if (autOrder.Agregar())
                        {
