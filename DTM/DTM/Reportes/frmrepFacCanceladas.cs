...
{
    public partial class frmrepFacCanceladas : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public DataTable verificarResultados(string fechaInicio, string fechaFin)
        {
            ...
            {
                DB dB = new DB();
                string query = "EXEC [dbo].[SP_FACTCANCELADAS] '" + fechaInicio + "','" + fechaFin + "'";
