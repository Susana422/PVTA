...
{
    public partial class frmrepPagoComision : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ruta = Settings.Settings.Default.rutaReportes.ToString() + "INFORMECOMISIONXCOBRANZA.rpt";
