...
{
    public partial class frmrepPagosCredito : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ruta = Settings.Settings.Default.rutaReportes.ToString() + "REPORTEDEPAGOSACREDITO.rpt";
        ...
        public DataTable verificarResultados(string fechaInicio, string fechaFin)
        {
            ...
            {
                DB dB = new DB();
                string query = "EXEC [dbo].[SP_COMPAGO] '" + fechaInicio + "','" + fechaFin + "'";
