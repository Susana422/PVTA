...
namespace NORI
{
    public partial class frmFormPagos : RibbonForm
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            List<ParametrizacionFormulario> parametrizacionForm = ParametrizacionFormulario.ObtenerRol("frmPagos", "PA", result2);
