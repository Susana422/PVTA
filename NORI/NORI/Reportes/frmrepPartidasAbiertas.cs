...
{
    public partial class frmrepPartidasAbiertas : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                string ruta = Settings.Settings.Default.rutaReportes.ToString() + "PARTIDAS ABIERTAS.rpt";
